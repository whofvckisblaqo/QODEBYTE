        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-12">
            ...
            <div className="mt-12 lg:mt-0 lg:w-1/2">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-emerald-500/20 bg-slate-900 aspect-video flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/20 to-[#137fec]/10" />
                <div className="relative z-10 flex flex-col items-center gap-4 text-center p-8">
                  <span className="material-symbols-outlined text-emerald-400 text-8xl">computer</span>
                  <p className="text-white font-bold text-lg">Type. Organize. Communicate.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-12">
            ...
            <div className="lg:w-1/2 mt-12 lg:mt-0 rounded-3xl bg-slate-200 h-64 lg:h-80 flex items-center justify-center">
              <span className="material-symbols-outlined text-slate-400 text-8xl">computer</span>
            </div>
          </div>
        </div>
      </section>
